...
pub static DCDT_ROLES: &[DcdtLocalRole] = &[
    DcdtLocalRole::Mint,
    DcdtLocalRole::Burn,
    DcdtLocalRole::Transfer,
];

pub static SFT_ROLES: &[DcdtLocalRole] = &[
    ...
    LiquidStakingContractObjBuilder: 'static + Copy + Fn() -> liquid_staking::ContractObj<DebugApi>,
{
    pub fn new(sc_builder: LiquidStakingContractObjBuilder) -> Self {
        ...
        b_mock.set_dcdt_local_roles(sc_wrapper.address_ref(), LS_TOKEN_ID, DCDT_ROLES);
        b_mock.set_dcdt_local_roles(sc_wrapper.address_ref(), UNSTAKE_TOKEN_ID, SFT_ROLES);
