...
pub static ERROR_OLD_CLAIM_START: &[u8] =
    b"Previous claimed rewards must be redelegated or lesser than 1 REWA";
pub static ERROR_CLAIM_REDELEGATE: &[u8] = b"Old claimed rewards must be greater than 1 REWA";
...
pub static ERROR_BAD_WHITELIST_FEE: &[u8] = b"Whitelisting contracts costs 1 REWA";
...
pub static ERROR_BAD_DELEGATION_AMOUNT: &[u8] = b"Delegation amount must be at least 1 REWA";
